# The `health` catalog. Generated by scripts/i18n-extract.py; do not
...
health-refreshing = [réfréshíñg…]

health-building = [búíldíñg thé répört…]

health-no_findings = [Ñö fíñdíñgs.]
