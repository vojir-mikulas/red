# The `inspector` catalog. Generated by scripts/i18n-extract.py; do not
...
inspector-row_evicted = This row scrolled out of view; load it to inspect.

inspector-empty = Select a cell to inspect its full value.
